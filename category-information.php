...
<!-- category-information.php -->
	...
	<div class="sp_category disp_sp">
		<select>
			<option value="<?php echo get_category_link('16');?>">お知らせ一覧</option>
			...
			<div class="info_wrap">
				...
				while (have_posts()) : the_post(); // 繰り返し処理開始 ?>
					...
					<div class="info_box clearfix">
						...
						<h2><?php the_title(); ?></h2>
						<?php the_content(); ?>
						<a href="<?php the_permalink(); ?>" class="eng readmore">&gt;&nbsp;READ MORE</a>
					</div>

				<?php endwhile; ?>
					<!-- pager -->
					<div class="pager clearfix">
						<p class="prev_link"><?php next_posts_link('&lt;&nbsp;OLDER POSTS'); ?></p>
						<p class="next_link"><?php previous_posts_link('NEWER POSTS&nbsp;&gt;'); ?></p>
					</div>
				<?php else : ?>
